...
define('OPENPNE_URL', 'http://alumni.yorii-chu.org/');
...
define('MYNETS_PREFIX_NAME','alm_');

// DB暗号化キー(56バイト以内のASCII文字列)
define('ENCRYPT_KEY', 'hanachan');

// メールサーバードメイン
// 携帯メール投稿の宛先などのドメイン名に使われる
define('MAIL_SERVER_DOMAIN', 'sns.yorii-chu.org');
...
// Google Maps API key
///
define('GOOGLE_MAPS_API_KEY', 'ABQIAAAA8OpxxRwsaWQXIckPacAJWhTYlB02mKH2dWGUaKjK_Zm2S3K3yhR1HjNZH_H13xHBq-fep1u7olvdng');
