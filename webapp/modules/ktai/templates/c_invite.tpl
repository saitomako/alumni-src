...
<center><font color="orange">部活動紹介</font></center>
<hr>
({if $c_friend_list})

({$WORD_MY_FRIEND_HALF})に部活動を紹介するﾒｯｾｰｼﾞを送信します。<br>
<br>
...
※部長から紹介した場合には、承認制の部活動にも承認無しで参加できます。<br>
<br>
...
<hr>
<a href="({t_url m=ktai a=page_c_home})&amp;target_c_commu_id=({$target_c_commu_id})&amp;({$tail})">部活動ﾄｯﾌﾟ</a><br>
