...
/////////////////////////////////////
        ...
        $countdown_days = get_countdown_days($member_data);
        $this->set('countdown_days', $countdown_days);
        ...
        $friend_diary = p_h_home_c_diary_friend_list4c_member_id($u, 10);
...
function get_countdown_days($c_member) {
	$ret = 0;
