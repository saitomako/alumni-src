...
<td style="width:600px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">部活動検索・並び替え</span></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
...
<img src="./skin/dummy.gif" class="icon arrow_1"><a href="({t_url m=pc a=page_h_com_add})">新規作成</a>&nbsp;(作成の前に、似た部活動がないかご確認ください)&nbsp;&nbsp;
</div>
...
<tr>
<td style="width:36px;" class="bg_06"><img src="({t_img_url_skin filename=content_header_1})" style="width:30px;height:20px;" class="dummy"></td>
<td style="width:600px;padding:2px 0px;" class="bg_06"><span class="c_00"><span class="b_b">部活動一覧</span>&nbsp;&nbsp;***&nbsp;
