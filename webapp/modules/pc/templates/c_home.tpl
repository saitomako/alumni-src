...
<span class="c_01">&nbsp;・この部活動に参加しますか？</span>
</td>
<td style="width:1px;" class="bg_01"><img src="./skin/dummy.gif" style="width:1px;height:1px;" class="dummy"></td>
...
<td style="width:241px;" class="bg_06"><span class="b_b c_00">部活動メンバー</span></td>
</tr>
</table>
<!-- ここまで：小タイトル -->
({*ここまで：header*})
...
<td style="width:300px;padding:2px 0px;" class="bg_06"><span class="b_b c_00">部活動</span></td>
...
<span class="c_01">部活動<br>説明文</span>
...
<span class="c_01">部活動<br>掲示板</span>
...
<table border="0" cellspacing="0" cellpadding="0" style="width:422px;">
    <tr>
        ...
        ({if $is_c_commu_admin})
            <img src="./skin/dummy.gif" class="icon arrow_1">
            <a href="({t_url m=pc a=page_c_edit})&amp;target_c_commu_id=({$c_commu.c_commu_id})">部活動設定変更</a>
            <br>
        ({/if})
        </div>
        ({/if})
...
<span class="c_01">部活動<br>書き込みを<br>携帯メールで</span>
...
<span class="c_01">部活動<br>書き込みを<br>PCメールで</span>
